...
class Main(object):
    def __init__(self,master):
        ...
        # center left frame
        centerLeftFrame = Frame(centerFrame, width=900, height=900, bg='#e0f0f0', borderwidth=2, relief='sunken')
        ...
        self.img_library = PhotoImage(file='LibIcons/library.png')
...
###################################### Tool Bar ####################################################
        ...
        # give book
        self.btngive = Button(topFrame,text='Give Book',font='arial 12 bold',padx=10,compound=LEFT,command=self.giveBook)
